  ...
  return (
    ...
    >
      <main
        ...
        className="flex w-full max-w-3xl flex-1 flex-col items-center justify-between bg-white px-16 py-32 sm:items-start dark:bg-black"
      >
        <Image
        ...
        >
          ...
          >
            ...
            <code
              data-testid="home-code-filename"
